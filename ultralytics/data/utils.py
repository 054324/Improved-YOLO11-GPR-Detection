...
class HUBDatasetStats:
    ...
    Args:
        path (str): Path to Multimodal data.yaml or data.zip (with Multimodal data.yaml inside data.zip). Default is 'coco8.yaml'.
    ...
    def _unzip(path):
        """Unzip data.zip."""
        if not str(path).endswith(".zip"):  # path is Multimodal data.yaml
