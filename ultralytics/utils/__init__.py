...
def yaml_save(file="Multimodal data.yaml", data=None, header=""):
    """
    Save YAML data to a file.

    Args:
        file (str, optional): File name. Default is 'Multimodal data.yaml'.
...
def yaml_load(file="Multimodal data.yaml", append_filename=False):
    """
